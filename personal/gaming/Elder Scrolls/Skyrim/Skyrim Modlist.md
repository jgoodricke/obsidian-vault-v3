...
- Free content
	...
	- Survival
- Dead Mans Dread
- Alternative Armors - Orcish Scale and Orcish plate
- Alternative armors - Silver
- Alternative armors - Elven?
- Netch Leather?
- Vigilants of Stendar one
...
- [ ] Synthesis Patcher
	...
	- [ ] facefixer
- [ ] Skypatcher
	- [ ] Khajiit has Wears Patch
## Utilities
- [ ] SKSEVR
- [ ] MergeMapper
- [ ] Address Library for SKSEVR
- [ ] PowerOfThrees Papyrus Extender VR
- [ ] PowerOfThrees Tweeks VR
	- [ ] Load Editor IDs must be enabled
...
- [ ] Auto Sneak Jump VR
- [ ] Controller Fix VR
- [ ] Smooth Carriage Ride VR
- [ ] Landscape Fixes For Grass Mods
- [ ] Cubemap Reflections
- [ ] Stagger Effect Fix
- [ ] Face Discolouration Fix
...
- [ ] Exterior FPS Boost
## Gameplay
- [ ] Unofficial Skyrim Special Edn Patch
...
### NPCs
- [ ] Diverse Skyrim
	- [ ] Sassy's Patch Emporium - Nordic(ish) Faces
- [ ] Open-Faced Guard Helmets
- [ ] Mods by SassiestAssassin
	- [ ] Project ja-Kha'jay
	...
	- [ ] Khajiit has Wears
		- [ ] Use SPID version.
		- [ ] Apex ESP Replacer
		- [ ] Gilded Doublet - Ported to SS
		- [ ] Lunar Guard Armor
		- [ ] Lunar Guard Arsenal - Battleaxe
		- [ ] Moon Monk's Robes
		- [ ] VickusDickus' Khajiiti Apex Armory Reforged
		- [ ] TODO: Add Akavari hats
- [ ] Nordic Faces
	- [ ] OR High-Poly Expressive NPCs
...
- [ ] my patch for race heights and carry weight.
...
- [ ] Blind People DAR Animations
	- [ ] Blind People Animations in the Dark and when blinded
...
- [ ] Sounds of Barenziah - Mystical
## Quality of Life
- [ ] SkyUI - VR
	- [ ] SkyUI VR - Disable New Item Sort
- [ ] Spell Auto-Aim VR
- [ ] VR Menu Mouse FIx
- [ ] Stable Hands - VR Mouse Stabilization mod
- [ ] Disable Input VR
...
- [ ] Plank
- [ ] Spell Wheel VR
- [ ] Pseudo-physical Weapon Collisions
- [ ] Immersive Crossbow Reloading VR
- [ ] Instant Equip VR
- [ ] Immersive Gathering
- [ ] Durability VR?
	- [ ] Immersive Smithing VR?
	- [ ] Honed Metal?
...
- [ ] Imperious - Races of Skyrim
	- [ ] Patch to remove Health, Magica and Stamina changes.
- [ ] Ordinator - Perks of Skyrim
- [ ] Sacrosanct - Vampires of Skyrim
- [ ] Spiderbros - Throwing Spider Overhaul
...
- [ ] Azurite Weather
- [ ] Seasons of Skyrim
	- [ ] Seasons of Skyrim VR
- [ ] *Seasonal Landscapes*
	- [ ] *My Patch*
	- [ ] *Seasonal Landscapes Unfrozen*
	- [ ] *Turn of the Seasons*
	- [ ] *Seasonal Landscape Additions.*
	- [ ] *Seasonal Landscapes - No Dead Pine Tree Resurrection*
- [ ] *Happy Little Trees*
- [ ] *EC Vanilla Tweaks - Winter Unending*
- [ ] *Seasonal Wildlife Distribution*
- [ ] *Seasonal Alchemy*
	- [ ] *Seasonal Alchemy Add-on - Critters and Fungi and Farm Crops*
- [ ] *Seasonal Santuralia Merchant*
...
- [ ] Arcane Accessories - Disenchant Robes
- [ ] Arcane Accessories - Spell Staff
- [ ] Arcane Accessories - Only Rare Books Quest!
- [ ] TODO: https://www.reddit.com/r/skyrimmods/comments/14iayk6/creation_club_integration_improvement_modlist/
- [ ] CC Arcane Archer - Tweaks and Enhancements

#### Quests
- [ ] Stendarrs Hammer Integration
- [ ] Morrowindlike Stendarrs Hammer
- [ ] *Creation Club Crossbows Rebalanced - Crossbows Belong to the Dawnguard*
- [ ] *On the Crimson Trail*
- [ ] *Knight of the North*
- [ ] Mihail's CC Zombies Overhaul (SE's Creation ClubAE)


### Farming
- [ ] *CC Farming - Tweaks Enhancements and Quest Expansion
	- [ ] Reduce gold amount in MCM.
- [ ] Skyrim Anniversary - Growable Plants
	- [ ] USSEP Patch
- [ ] Hearthfire Customisable Planters
	- [ ] Make patch to increase growing time to 7 days. Also make globals read-only.
### Voiced Narrative
- [ ] Voiced Narrative - Redguard Elite Armaments
- [ ] Voiced Narrative - Fishing
- [ ] Voiced Narrative - Ghosts of the Tribunal.
- [ ] Voiced Narrative - Saints and Seducers
- [ ] Voiced Narrative - Grey Cowl Returns
- [ ] Voiced Narrative - Bloodchill Manor
- [ ] Voiced Narrative - Farming

#### Distribution - SPID
- [ ] *Orcish Strongholds Use Orcish Equipment*
- [ ] Dead Man's Dread Outfits for Pirates and Sailors (SPID)
	- [ ] Pirates Wield Cutlasses
		- [ ] Pirates Wield Scurvy Cutlasses
		- [ ] Pirates Wield Cutlasses SPID
- [ ] Dunmeri Outfits for Skyrim Dunmers
- [ ] Dwarven Mail Outfits for Dwemer Enthusiasts
- [ ] Vigil Enforcer Armors for Vigilants of Stendarr
...
#### Distribution - Non-SPID
- [ ] *Tamrielic Distribution*
- [ ] Bandit Brawlers
	- [ ] Fearsome Fists Integration
- [ ] *Ghosts of the Tribunal - Solstheim Integration*
- [ ] Diverse Redguard Clothes - Creation Club Integration

### Enemies
- [ ] Bone Colossus - Necromantic Grimoire Integrated
- [ ] 
### Less HUD
...
- [ ] *Reasonable Quest Rewards*
	- [ ] Bounties are Worthwhile Patch
- [ ] *Bounties are Worthwhile*
- [ ] My patch for reduced carry weight
