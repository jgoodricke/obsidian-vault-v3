...
Assess whether the employee exercised rights protected by the Fair Work Act.
...
Evaluate actions taken by the employer after the workplace right was exercised.
...
A key focus should be determining whether the adverse action may have been taken **because the workplace right was exercised**.
...
Consider how the employer may defend their actions.
...
Whether negative actions occurred **soon after the flexible work request**.

### Procedural fairness

Whether the performance process followed normal workplace procedures.

### Consistency

Whether the employer’s explanations have changed over time.

### Escalation

Whether disciplinary action suddenly intensified after the workplace right was exercised.

### Documentation

Whether the employer appears to have created documentation after the fact to justify decisions.
