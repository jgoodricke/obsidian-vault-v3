  ...
  | 7.5 | Any feature that previously read facility.email in code | git grep -n "facility->email\b\|->email\>" app/ resources/ should return no live references outside of the migration itself (covered by audit cbr-a24dc769) |
