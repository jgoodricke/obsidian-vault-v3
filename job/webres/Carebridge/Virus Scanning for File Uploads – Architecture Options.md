## 1. Inline scanning during upload (synchronous)
...
# 3. Event-driven scanning using AWS services
...
# Practical Recommendation for Our Stack

**Best option:**  
**Asynchronous scanning using ClamAV with queue workers**

Reason:

- Fits **Laravel architecture well**
...
If you'd like, I can also write a **very short “30-second explanation” version** you can give in meetings when someone asks this question again.